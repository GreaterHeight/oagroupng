...
# 13. IMAGE PLACEMENT SUMMARY

| Page | Asset | Placement |
|---|---|---|
| Site-wide | `OAGroup-logo.png` | Header + footer |
| Home | `oagroup-hero.mp4` | Full-bleed hero |
| Home | `hero-video-poster.jpg` | Hero fallback/poster |
| Home | `insight-tax-reform.jpg` | Insight card |
| Home | `insight-revenue-recovery.jpg` | Insight card |
| Home | `insight-diaspora-property.jpg` | Insight card |
| About | `about-institutional-architecture.jpg` | Institutional feature |
| Our Companies | `our-companies-portfolio.jpg` | Portfolio feature |
| Solutions | `solutions-integrated.jpg` | Integrated solutions feature |
| Industries | `industries-nigeria.jpg` | Nigerian market feature |
| Careers | `careers-culture.jpg` | Culture/team feature |
| Gallery | `gallery-office-team-01.jpg` | Office & Team |
| Gallery | `gallery-office-team-02.jpg` | Office & Team |
| Gallery | `gallery-project-01.jpg` | Projects |
| Gallery | `gallery-project-02.jpg` | Projects |
| Gallery | `gallery-project-03.jpg` | Projects |
| Gallery | `gallery-project-04.jpg` | Projects |
| Gallery | `gallery-property-01.jpg` | Properties |
| Gallery | `gallery-property-02.jpg` | Properties |
| Gallery | `gallery-property-03.jpg` | Properties |
| Gallery | `gallery-events-training-01.jpg` | Events & Training |
| Gallery | `gallery-events-training-02.jpg` | Events & Training |
| Gallery | `gallery-events-training-03.jpg` | Events & Training |
| Gallery | `gallery-video-01.jpg` | Video thumbnail |
| Gallery | `gallery-video-02.jpg` | Video thumbnail |
| Gallery | `gallery-video-03.jpg` | Video thumbnail |
| Contact | `contact-office.jpg` | Contact feature |
| Contact | `contact-lagos.jpg` | Lagos location visual |
| FAQ | `faq-institutional.jpg` | Supporting feature |
| Insights | 8 `article-*.jpg` assets | Article `.page-hero` |

---

# 14. PRODUCTION / WEB DELIVERY RULES

- Generate masters at 4K/8K where supported.
- Use high-quality JPG files as the canonical supplied image format for this project. Optimize/compress JPGs for web delivery without visible degradation.
- Resize to the largest actual rendered component size plus sensible density allowance.
- Compress without visible degradation.
- Include explicit `width` and `height` attributes in HTML to prevent layout shift.
- Use `loading="lazy"` below the fold.
- Keep the hero poster optimized for first paint.
- Do not use external stock-image URLs.
- Use descriptive `alt` text based on the final image.
- Decorative images should use empty alt text where appropriate.
- Compose for the intended `.arch-frame` crop, including mobile cropping.
- Do not remove the `.arch-frame` wrapper.

---

# 15. SINGLE-SOURCE-OF-TRUTH RULE

This file is now the **single master visual-production document**.

Do not create a separate `IMAGE-PLACEMENT-MAP.md`.

Whenever a new image is required, add:
1. Asset path
2. Page/component placement
3. Purpose
